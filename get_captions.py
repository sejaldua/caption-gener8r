...
from util.caption_extractor import extract_information
from util.caption_extractor import extract_user_posts
...
try:
    ...
    for username in usernames:
        ...
        try:
            information = extract_user_posts(browser, Settings.limit_amount)
        except:
